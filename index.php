...
$siteUrl = 'https://sleeptiming.org';

$seo = [
    'uk' => [
        'title'       => 'Калькулятор циклів сну — коли лягати і прокидатися | SleepTiming',
        'description' => 'Безкоштовний калькулятор сну: розрахуйте оптимальний час щоб лягти спати або прокинутися, виходячи з циклів сну по 90 хвилин. Денний сон, аналіз сну, план вечора.',
        'ogTitle'     => 'Калькулятор циклів сну — прокидайся у правильний момент',
    ],
    'en' => [
        'title'       => 'Sleep Cycle Calculator — Best Bedtime & Wake-Up Time | SleepTiming',
        'description' => 'Free sleep cycle calculator: find the best time to go to bed or wake up based on 90-minute sleep cycles. Includes nap calculator, sleep analysis and bedtime routine planner.',
        'ogTitle'     => 'Sleep Cycle Calculator — Wake Up at the Right Moment',
    ],
];

$altLang = $lang === 'uk' ? 'en' : 'uk';
$canonicalUrl = $siteUrl . '/?lang=' . $lang;
?>
<!DOCTYPE html>
...
<title><?= htmlspecialchars($seo[$lang]['title'], ENT_QUOTES, 'UTF-8') ?></title>
<meta name="description" content="<?= htmlspecialchars($seo[$lang]['description'], ENT_QUOTES, 'UTF-8') ?>" />

<!-- SEO: Canonical & Hreflang -->
<link rel="canonical" href="<?= htmlspecialchars($canonicalUrl, ENT_QUOTES, 'UTF-8') ?>" />
<link rel="alternate" hreflang="uk" href="<?= $siteUrl ?>/?lang=uk" />
<link rel="alternate" hreflang="en" href="<?= $siteUrl ?>/?lang=en" />
<link rel="alternate" hreflang="x-default" href="<?= $siteUrl ?>/?lang=uk" />

<!-- SEO: Open Graph -->
<meta property="og:type" content="website" />
<meta property="og:url" content="<?= htmlspecialchars($canonicalUrl, ENT_QUOTES, 'UTF-8') ?>" />
<meta property="og:title" content="<?= htmlspecialchars($seo[$lang]['ogTitle'], ENT_QUOTES, 'UTF-8') ?>" />
<meta property="og:description" content="<?= htmlspecialchars($seo[$lang]['description'], ENT_QUOTES, 'UTF-8') ?>" />
<meta property="og:site_name" content="SleepTiming" />
<meta property="og:locale" content="<?= $lang === 'uk' ? 'uk_UA' : 'en_US' ?>" />
<meta property="og:locale:alternate" content="<?= $lang === 'uk' ? 'en_US' : 'uk_UA' ?>" />

<!-- SEO: Twitter Card -->
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="<?= htmlspecialchars($seo[$lang]['ogTitle'], ENT_QUOTES, 'UTF-8') ?>" />
<meta name="twitter:description" content="<?= htmlspecialchars($seo[$lang]['description'], ENT_QUOTES, 'UTF-8') ?>" />
...
<script type="application/ld+json">
{
  ...
  "@type": "WebApplication",
  "name": "SleepTiming — Sleep Cycle Calculator",
  "url": "<?= $siteUrl ?>",
  "description": "<?= addslashes($seo[$lang]['description']) ?>",
